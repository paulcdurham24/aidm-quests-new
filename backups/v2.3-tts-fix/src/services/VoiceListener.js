...
// Polyfill: RN 0.72+ removed NativeEventEmitter.removeListener but
// @react-native-voice/voice v3.x still relies on it internally
if (NativeEventEmitter.prototype && !NativeEventEmitter.prototype.removeListener) {
  NativeEventEmitter.prototype.removeListener = function (_eventType, _listener) {
    // No-op — subscriptions should use .remove() instead
  };
}
