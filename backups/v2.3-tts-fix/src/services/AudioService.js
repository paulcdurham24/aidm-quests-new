...
export class AudioService {
  ...
  playFallbackSound(soundId) {
    ...
    const keywordMap = {
      // Specific multi-word matches first (checked before single keywords)
      'door knock': 'two_door_knocks',
      'door knocks': 'two_door_knocks',
      'knocking': 'two_door_knocks',
      'knock': 'two_door_knocks',
      'door creak': 'creaky_old_door_472357',
      'creaking door': 'creaky_old_door_472357',
      'door slam': 'door_slamming_shut_478363',
      'door close': 'door_close',
      'door open': 'door_open',
      'open door': 'door_open',
      'stone grinding': 'door_open',
      'grinding stone': 'door_open',
      'heavy breathing': 'monster_growl',
      'breathing': 'monster_growl',
      'heartbeat': 'heartbeat',
      'heart beat': 'heartbeat',
      'rustling': 'rustling_bushes',
      'leaves': 'rustling_bushes',
      'footstep': 'footsteps',
      'step': 'footsteps',
      'walk': 'footsteps',
      'running': 'footsteps',
      ...
      'swing': 'sword_swing',
      'sword': 'sword_swing',
      'clang': 'sword_fight_393849',
      'clash': 'sword_fight_393849',
      'hit': 'hit_impact',
      'impact': 'hit_impact',
      'punch': 'classic_punch_impact',
      'thud': 'hit_impact',
      ...
      'enchant': 'magic_sound',
      'rune': 'magic_sound',
      'ethereal': 'magic_sound',
      'mystical': 'magic_sound',
      'shimmer': 'magic_sound',
      'glow': 'magic_sound',
      'aura': 'magic_sound',
      'otherworldly': 'ghost_eerie_ambiance',
      'whisper': 'ghost_eerie_ambiance',
      'eerie': 'ghost_eerie_ambiance',
      'chime': 'spooky_chimes',
      'hum': 'magic_sound',
      'resonat': 'magic_sound',
      'puls': 'magic_sound',
      ...
      // Environment
      'splash': 'big_rock_splash_467479',
      'water': 'big_rock_splash_467479',
      'wind': 'ominous_wind',
      'thunder': 'thunderstorm_ambience_2_19565',
      'lightning': 'thunderstorm_ambience_2_19565',
      'rain': 'soft_rain_atmosphere',
      'crackle': 'fire_sounds',
      'flame': 'fire_spell_impact_448565',
      // Monsters
      'ghost': 'ghost_eerie_ambiance',
      'zombie': 'zombie_moan_sfx_454252',
      'dragon': 'dragon_roar_4_364609',
      'wolf': 'monster_howl',
      'goblin': 'goblin_cackle',
      'troll': 'troll_roars',
      'skeleton': 'skeleton_death_breath',
      // Animals
      'horse': 'horse_galloping',
      'bird': 'peaceful_birds',
      'crow': 'crow_calls_raspy_echoing_472377',
      'eagle': 'eagle_sound_382725',
      'frog': 'frogs_croaking_at_night_329855',
      // Misc
      'bell': 'bell',
      ...
      'explosion': 'explosion_with_debri',
      'victory': 'victory_music',
      'cheer': 'crowd_cheer_and_applause_406644'
    };
